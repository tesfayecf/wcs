...
const DashboardIcon: React.FunctionComponent<IDashboardIconProps> = (props: IDashboardIconProps) => {
    ...
    return (
        <svg width={size} height={size} viewBox={viewBox} fill={fill} xmlns="http://www.w3.org/2000/svg" stroke={stroke} stroke-width={strokeWidth}>
