...
//             <Today current={current} unitsLabels={unitsLabels} locationLabel={locationLabel}></Today>
//             {showForecast && <Forecast unitsLabels={unitsLabels} forecast={forecast} />}
//         </div>
//     )
// }

// const Today = ({ current, unitsLabels, locationLabel }) => {
//     const labels = { wind: "wind", humidity: "humidity" };
//     return (
//         <div className="weather-today-container">
//             <div className="weather-today-data-container">
//                 <h2 className="weather-today-data-location">{locationLabel}</h2>
//                 <p className="weather-today-data-date">{current.date}</p>
...
//                     {current.temperature.max} / {current.temperature.min}{' '}{unitsLabels.temperature}
//                 </p>
//                 <p className="weather-today-data-description">{current.description}</p>
//                 <div className="weather-today-data-division-line" />
...
//                 <WeatherSVG path={current.icon} size={90} title={current.description} />
//             </div>
//         </div>
...
// const Forecast = ({ unitsLabels, forecast }) => {
//     return (
...
// const WeatherSVG = ({ title, path, size, viewBox, color }) => {
//     return (
//         <svg
//             color={color}
//             version="1.1"
