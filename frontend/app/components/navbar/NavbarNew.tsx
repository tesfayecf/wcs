...
import styles from './styles/NavbarNew.module.scss'
...
const NavbarNew: React.FunctionComponent<INavbarProps> = (props: INavbarProps) => {
...
export default connect(mapStateToProps, {})(NavbarNew)
        ...
        <div className={contClass} >
            <Link href={props.index} style={{ textDecoration: 'none' }}>
                <div id='navkey' className={styles.navkey}>
                    ...
                    <span id='navkey-texts' className={textClass} style={{ textDecoration: 'none' }}>
                        {props.text}
                    </span>
                </div>
            </Link >
