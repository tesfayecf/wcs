...
const AddWaterTankPopUp2: React.FunctionComponent<IAddWaterTankPopUpProps> = (props: IAddWaterTankPopUpProps) => {
    ...
    return (
        <>
            <PopUpFormTemplate
                ...
                onCancel={onClose}
                onSubmit={() => {console.log(tankCreationForm) }}
                ...
                fields={[
                    ...
                    },
                    {
                        ...
                        value: tankCreationForm.capacity.toString(),
...
export default AddWaterTankPopUp2;
